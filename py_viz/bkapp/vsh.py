...
def eval_vsh(num_data):
    ...
    <div>
        ...
        <span style="font-size: 8px; color: #0CFF0C;"><b>VSH:</b> @VSH{0.2f}</span><br>
    ...
    p3.scatter(x='VSH', y='prediction', color='color', alpha=0.5, source=source)
    ...
    <div>
        ...
        <span style="font-size: 8px;"><b>DEPTH:</b> @DEPTH{0.2f}</span><br>
        <span style="font-size: 8px;"><b>index:</b> @index</span><br>
        <span style="font-size: 8px;"><b>VSH:</b> @VSH{0.2f}</span><br>
